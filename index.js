...
const createBoard = () => {
    for (let i = 0; i < gameDOM.length; i++) {
        for (let j = 0; j < gameDOM[i].length; j++) {
            ...
            card.setAttribute("src", "./memorypublic/cover.jpg");
